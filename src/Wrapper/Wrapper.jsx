  ...
  return (
    <div className="wrapper">
      <Routes>
        <Route
          path="/list"
          element={<TaskList1 className="wrapper__item TaskList1" />}
        />
        <Route
          path="/create"
          element={<CreateTask className="wrapper__item create_task" />}
        />
        <Route
          path="/login"
          element={<Login className="wrapper__item login_page" />}
        />
        <Route
          path="/edit"
          element={<EditTask className="wrapper__item edit_task" />}
        />
        <Route
          path="*"
          element={<TaskList2 className="wrapper__item TasksList" />}
        />
      </Routes>
