        ...
        <div className="wrapper">
            <UserContext.Provider value={{IsUser, setIsUser}}>
                <Routes>
                    ...
                    <Route path="/list" element={IsUser ? <TaskList1 className="wrapper__item TaskList1"/> :
                        <Navigate to={'/login'}/>}/>
                    <Route path="/create" element={IsUser ? <CreateTask className="wrapper__item create_task"/> :
                        <Navigate to={'/login'}/>}/>
                    <Route path="/login"
                           element={IsUser ? <Navigate to={'/list'}/> : <Login className="wrapper__item login_page"/>}/>
                    <Route path="/edit" element={IsUser ? <EditTask className="wrapper__item edit_task"/> :
                        <Navigate to={'/login'}/>}/>
                    <Route path="*" element={IsUser ? <TaskList2 className="wrapper__item TasksList"/> :
                        <Navigate to={'/login'}/>}/>
